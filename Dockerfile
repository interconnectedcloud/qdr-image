FROM fedora:30
RUN dnf -y install glibc.i686 cyrus-sasl-lib cyrus-sasl-plain libuuid openssl python gettext hostname iputils libwebsockets-devel gdb valgrind && dnf -y update && dnf clean all
